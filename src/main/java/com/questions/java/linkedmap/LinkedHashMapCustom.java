...
public class LinkedHashMapCustom<K, V> {
    ...
    private MyEntry<K, V> header; //head of the doubly linked list.
    private MyEntry<K, V> last; //last of the doubly linked list.
     ...
     */
    private void maintainOrderAfterInsert(MyEntry<K, V> newEntry) {
        ...
        MyEntry<K, V> beforeDeleteEntry = deleteSpecificEntry(newEntry);
     ...
     */
    private void maintainOrderAfterDeletion(MyEntry<K, V> deleteEntry) {
     ...
     */
    private void insertAfter(MyEntry<K, V> beforeDeleteEntry, MyEntry<K, V> newEntry) {
        MyEntry<K, V> current = header;
     ...
     */
    private void insertFirst(MyEntry<K, V> newEntry) {
     ...
     */
    private void insertLast(MyEntry<K, V> newEntry) {
     ...
     */
    private MyEntry<K, V> deleteSpecificEntry(MyEntry<K, V> newEntry) {
        ...
        MyEntry<K, V> beforeDeleteEntry = current.before;
    ...
    public void display() {
        ...
        MyEntry<K, V> currentEntry = header;
